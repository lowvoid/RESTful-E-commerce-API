...
from .serializers import OrderSerializer, OrderCreateSerializer, ProductInfoSerializer, ProductSerializer, UserSerializer
...
class OrderViewSet(viewsets.ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        send_order_confirmation_email.delay(self.request.user.email, str(order.order_id))
